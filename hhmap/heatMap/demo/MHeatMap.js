...
function _initMHeatMap() {
    ...
    return a.prototype = {
        ...
        setMap: function(a) {
            return this._map = a || this._map, this.type = "undefined" != typeof Maplet && this._map instanceof Maplet ? "pc" : "h5", this._updateZoomLevelRange(), this._update(!0), this._listenEvent(), this
        },
        update: function() {
        ...
        show: function() {
            return this._visibility || (this._needRef = !0, this._visibility = !0, this._visible(!0) && this._needRef && (this._needRef = !1, this._refresh())), this
        },
        isVisible: function() {
...
function _initHeatMapPlgin(a) {
    ...
    }, c.prototype.disableHeatmap = function() {
