 ...
 * time:Tue Jan 26 2016 17:06:59 GMT+0800 (中国标准时间)
 */

function _initMHeatMap() {
    function a(a) { this._data = { data: [], min: 0, max: 1 }, this._opts = { autoRender: !0 }, this.setOptions(a, !1), this._visibility = !0, this._needRef = !1, this.type = null }
    return a.prototype = {
        constructor: a,
        ...
        setMap: function(a) { return this._map = a || this._map, this.type = "undefined" != typeof Maplet && this._map instanceof Maplet ? "pc" : "h5", this._updateZoomLevelRange(), this._update(!0), this._listenEvent(), this },
        ...
        show: function() { return this._visibility || (this._needRef = !0, this._visibility = !0, this._visible(!0) && this._needRef && (this._needRef = !1, this._refresh())), this },
...
function _initHeatMapPlgin(a) {
    var b = _initMHeatMap(),
        c = a;
    return c.prototype.enableHeatmap = function(a, c) {
        var d = "undefined" != typeof MCanvas ? "pc" : "h5";
        if (!this.heatmapLayer)
            ...
            } else "h5" === d && (this.heatmapLayer = document.createElement("div"), this.heatmapLayer.style.position = "absolute", this.heatmapLayer.style.zIndex = 3, document.getElementById("mapContainer").appendChild(this.heatmapLayer));
        return this._heatmap || (this._heatmap = new b(a).setMap(this), this.heatmapLayer.appendChild(this._heatmap.getContainer()), c && this._heatmap.setData(c)), this._heatmap
    }, c.prototype.disableHeatmap = function() { return this._heatmap && (this.heatmapLayer && this.heatmapLayer.removeChild(this._heatmap.getContainer()), this._heatmap.finalize(), this._heatmap = null), this }, c.prototype.showHeatmap = function() { return this._heatmap && this._heatmap.show(), this }, c.prototype.hideHeatmap = function() { return this._heatmap && this._heatmap.hide(), this }, c.prototype.getHeatmap = function() { return this._heatmap }, b
}! function(a, b, c) { b[a] = c(), "undefined" != typeof window.Maplet ? window.Maplet && Maplet.define && Maplet.define("MHeatMap", function() { return _initHeatMapPlgin(b) }) : MPlugin.define && MPlugin.define("MHeatMap", function() { return _initHeatMapPlgin(b) }) }("h337", "undefined" != typeof MMap ? MMap : Maplet, function() {
